[![Traefik Deploy](https://github.com/Geonovum/ogc-api-sandbox/actions/workflows/deploy.traefik.yml/badge.svg)](https://github.com/Geonovum/ogc-api-sandbox/actions/workflows/deploy.traefik.yml)
